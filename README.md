...
> **ВАЖНО!** ПОДДЕРЖКА ДАННОГО ПРОЕКТА ПРЕКРАЩЕНА, СОСТОЯНИЕ СТАБИЛЬНОЕ, ИЗВЕСТНЫХ ОШИБОК НЕ ОБНАРУЖЕНО. ВМЕСТО НЕГО РЕКОМЕНДУЕТСЯ ИСПОЛЬЗОВАТЬ [EcsProto](https://gitverse.ru/leopotam/ecsproto).
